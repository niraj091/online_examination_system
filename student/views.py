...
class Register(View):
    ...
    def post(self,request):
        ...
        if student_form.is_valid() and student_info_form.is_valid() and student_form.cleaned_data['password'] == student_form.cleaned_data['confirm_password']:
        ...
        elif  student_form.data['password'] != student_form.data['confirm_password']:
